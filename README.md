This is a very simple Magic 8-Ball program. It lets users input their name, a question, and generates a random response. It has code for either Switch Statements or Else If.
